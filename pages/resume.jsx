					...
					<section>
						<div>
							...
							<p className='text-center text-md py-2 leading-8 text-gray-800 dark:text-white'>
								Я, Литвинчук Захар, начинающий web-разработчик. На данный момент
								обучаюсь на первом курсе университета
						...
						<div className='lg: flex gap-5 justify-center'>
							<div className='bg-white dark:bg-comment grid w-center place-items-center text-center shadow-lg p-5 rounded-xl my-10'>
								...
								<a
									href='mailto:litvinchuk2016@mail.ru'
									className='text-black hover:text-purp duration-300 dark:text-cyan py-2'
								>
									Email
								</a>
								<a
									href='tel:+79266526991'
									className=' text-black hover:text-purp duration-300 dark:text-cyan py-2 dark:hover:text-purple'
								>
									Телефон
								</a>
								<a
									href='https://t.me/raynelz'
									className='py-2 text-black hover:text-purp duration-300 dark:text-cyan dark:hover:text-purple'
								>
									Telegram
								</a>
							</div>
							<div className='bg-white dark:bg-comment grid w-center place-items-center text-center shadow-lg p-5 rounded-xl my-10'>
								...
								<p className='py-2 text-black dark:text-white'>
									<span className='text-pink600 dark:text-cyan'>ВУЗ: </span>НИТУ
									МИСиС
								</p>
								<p className='py-2 text-black dark:text-white'>
									<span className=' text-pink600 dark:text-cyan'>
					...
					<section className=''>
						<div className='lg: flex gap-5 justify-center'>
							...
							<div className='bg-white dark:bg-comment grid w-center place-items-center text-center shadow-lg p-5 rounded-xl my-10'>
								...
								<p className='py-2 text-black dark:text-white'>
									<span className='text-black dark:text-cyan'>Хобби:</span>{' '}
									фото-видеосъёмка
								</p>
